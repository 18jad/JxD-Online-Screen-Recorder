...
!(function (t) {
  ...
  return (
    (c.prototype = {
      ...
      init: function (e, i) {
        ...
        (this.$element = t(e)),
          void 0 !== this.$element[0].id && "" !== this.$element[0].id
            ...
            : ((this.id = a + Math.floor(1e7 * Math.random() + 1)),
          ...
          void 0 === this.group.name &&
            ...
            this.$element.attr("data-" + a + "-group", i.group)),
          this.options.loop === !0 &&
            this.$element.attr("data-" + a + "-loop", !0),
          ...
          (this.$wrap = this.$element.find("." + a + "-wrap")),
          null === i.zindex ||
          ...
          "" !== i.padding &&
            this.$element.find("." + a + "-content").css("padding", i.padding),
          "" !== i.theme &&
            ("light" === i.theme
              ? this.$element.addClass(a + "-light")
              : this.$element.addClass(i.theme)),
          i.rtl === !0 && this.$element.addClass(a + "-rtl"),
          i.openFullscreen === !0 &&
      ...
      createHeader: function () {
        (this.$header = t(
          ...
          "" === this.options.subtitle &&
            this.$header.addClass(a + "-noSubtitle"),
          "" !== this.options.title &&
            ...
            (null === this.options.icon && null === this.options.iconText) ||
              (this.$header.prepend('<i class="' + a + '-header-icon"></i>'),
      ...
      setGroup: function (e) {
        ...
        if (
          ...
          void 0 !== e &&
            ...
            ((n = e),
            (this.group.name = n),
            this.$element.attr("data-" + a + "-group", n)),
          void 0 !== n && "" !== n)
        ) {
          var o = 0;
          t.each(
      ...
      toggle: function () {
        this.state == r.OPENED && this.close(),
          this.state == r.CLOSED && this.open();
      },
      open: function (e) {
        function i() {
          (o.state = r.OPENED),
            o.$element.trigger(r.OPENED),
            o.options.onOpened &&
              "function" == typeof o.options.onOpened &&
              o.options.onOpened(o);
        }
        function n() {
          o.$element
            .off("click", "[data-" + a + "-close]")
            .on("click", "[data-" + a + "-close]", function (e) {
              e.preventDefault();
              var i = t(e.currentTarget).attr("data-" + a + "-transitionOut");
              void 0 !== i ? o.close({ transition: i }) : o.close();
            }),
            o.$element
              .off("click", "[data-" + a + "-fullscreen]")
              .on("click", "[data-" + a + "-fullscreen]", function (t) {
                t.preventDefault(),
                  o.isFullscreen === !0
                    ? ((o.isFullscreen = !1),
                      o.$element.removeClass("isFullscreen"))
                    : ((o.isFullscreen = !0),
                      o.$element.addClass("isFullscreen")),
                  o.options.onFullscreen &&
                    "function" == typeof o.options.onFullscreen &&
                    o.options.onFullscreen(o),
                  o.$element.trigger("fullscreen", o);
              }),
            o.$navigate
              .off("click", "." + a + "-navigate-next")
              .on("click", "." + a + "-navigate-next", function (t) {
                o.next(t);
              }),
            o.$element
              .off("click", "[data-" + a + "-next]")
              .on("click", "[data-" + a + "-next]", function (t) {
                o.next(t);
              }),
            o.$navigate
              .off("click", "." + a + "-navigate-prev")
              .on("click", "." + a + "-navigate-prev", function (t) {
                o.prev(t);
              }),
            o.$element
              .off("click", "[data-" + a + "-prev]")
              .on("click", "[data-" + a + "-prev]", function (t) {
                o.prev(t);
              });
        }
        var o = this;
        if (this.state == r.CLOSED) {
          if (
            ...
            this.$element.trigger(r.OPENING),
            this.$element.attr("aria-hidden", "false"),
            this.options.iframe === !0)
          ) {
            this.$element
              .find("." + a + "-content")
              .addClass(a + "-content-loader"),
              this.$element.find("." + a + "-iframe").on("load", function () {
                t(this)
                  .parent()
                  .removeClass(a + "-content-loader");
              });
            var d = null;
            try {
              d =
            ...
            (function () {
              if (o.group.ids.length > 1) {
                o.$navigate.appendTo("body"),
                  o.$navigate.addClass(o.options.transitionInOverlay),
                  o.options.navigateCaption === !0 &&
                    o.$navigate.find("." + a + "-navigate-caption").show();
                var n = o.$element.outerWidth();
                o.options.navigateArrows !== !1
                  ? "closeScreenEdge" === o.options.navigateArrows
                    ? (o.$navigate
                        .find("." + a + "-navigate-prev")
                        .css("left", 0)
                        .show(),
                      o.$navigate
                        .find("." + a + "-navigate-next")
                        .css("right", 0)
                        .show())
                    : (o.$navigate
                        .find("." + a + "-navigate-prev")
                      ...
                      o.$navigate
                        ...
                        .show())
                  : (o.$navigate.find("." + a + "-navigate-prev").hide(),
                    o.$navigate.find("." + a + "-navigate-next").hide());
                var s;
                0 === o.group.index &&
                  ((s = t(
                    "." +
                  ...
                  0 === s &&
                    o.options.loop === !1 &&
                    o.$navigate.find("." + a + "-navigate-prev").hide()),
                  o.group.index + 1 === o.group.ids.length &&
                    ((s = t(
                      "." +
                        a +
                        "[data-" +
              ...
              o.options.overlay === !0
                ? o.$overlay.appendTo("body")
                : t(o.options.overlay).length > 0 &&
                  o.$overlay.appendTo(t(o.options.overlay)),
                o.options.transitionInOverlay &&
                  o.$overlay.addClass(o.options.transitionInOverlay);
              var r = o.options.transitionIn;
              "object" == typeof e &&
                ((void 0 === e.transition && void 0 === e.transitionIn) ||
                  (r = e.transition || e.transitionIn)),
                "" !== r
                  ? (o.$element.addClass("transitionIn " + r).show(),
                    o.$wrap.one(l, function () {
                      o.$element.removeClass(r + " transitionIn"),
                        o.$overlay.removeClass(o.options.transitionInOverlay),
                        o.$navigate.removeClass(o.options.transitionInOverlay),
                        i();
                    }))
                  : (o.$element.show(), i()),
                o.options.pauseOnHover !== !0 ||
                  o.options.pauseOnHover !== !0 ||
                  o.options.timeout === !1 ||
                  isNaN(parseInt(o.options.timeout)) ||
                  o.options.timeout === !1 ||
                  0 === o.options.timeout ||
                  (o.$element.off("mouseenter").on("mouseenter", function (t) {
              ...
              (this.options.timeoutProgressbar === !0
                ? ((this.progressBar = {
                    ...
                    updateProgress: function () {
                      if (!o.isPaused) {
                        o.progressBar.currentTime =
                          o.progressBar.currentTime + 10;
                        var t =
                          ((o.progressBar.hideEta - o.progressBar.currentTime) /
                            o.progressBar.maxHideTime) *
                          100;
                  ...
                  this.options.timeout > 0 &&
                    ((this.progressBar.maxHideTime = parseFloat(
      ...
      close: function (e) {
        function i() {
          (n.state = r.CLOSED),
            n.$element.trigger(r.CLOSED),
            n.options.iframe === !0 &&
              n.$element.find("." + a + "-iframe").attr("src", ""),
            (n.options.bodyOverflow || h) &&
              (t("html").removeClass(a + "-isOverflow"),
              h && t("body").css("overflow", "auto")),
            n.options.onClosed &&
              "function" == typeof n.options.onClosed &&
              n.options.onClosed(n),
            n.options.restoreDefaultContent === !0 &&
              n.$element.find("." + a + "-content").html(n.content),
            0 === t("." + a + ":visible").length &&
              t("html").removeClass(a + "-isAttached");
        }
        var n = this;
        if (this.state == r.OPENED || this.state == r.OPENING) {
          s.off("keydown." + a),
            (this.state = r.CLOSING),
            this.$element.trigger(r.CLOSING),
            this.$element.attr("aria-hidden", "true"),
            ...
            "" !== o
              ? (this.$element.attr(
                  ...
                  [
                    ...
                    this.options.rtl ? a + "-rtl" : "",
                  ].join(" "),
                ),
                this.$overlay.attr(
                  "class",
                  a + "-overlay " + this.options.transitionOutOverlay,
                ),
                n.options.navigateArrows !== !1 &&
                  this.$navigate.attr(
                    "class",
                    a + "-navigate " + this.options.transitionOutOverlay,
                  ),
                this.$element.one(l, function () {
      ...
      next: function (e) {
        ...
        (r.out = this),
          void 0 !== e && "object" != typeof e
            ? (e.preventDefault(),
              (s = t(e.currentTarget)),
              (n = s.attr("data-" + a + "-transitionIn")),
              (o = s.attr("data-" + a + "-transitionOut")))
            : void 0 !== e &&
            ...
            for (
              ...
              if ((o == i.group.ids.length && e > 0) || i.options.loop === !0)
                for (var l = 0; l <= i.group.ids.length; l++)
                  if (
                    ((r["in"] = t("#" + i.group.ids[l]).data().iziModal),
                    "undefined" != typeof r["in"])
                  ) {
          ...
          t(document).trigger(a + "-group-change", r);
      },
      prev: function (e) {
        var i = this,
          n = "fadeInLeft",
      ...
      destroy: function () {
        ...
        this.$element.trigger(e),
          ...
          clearTimeout(this.timerTimeout),
          this.options.iframe === !0 &&
            this.$element.find("." + a + "-iframe").remove(),
          this.$element.html(this.$element.find("." + a + "-content").html()),
          this.$element.off("click", "[data-" + a + "-close]"),
          this.$element.off("click", "[data-" + a + "-fullscreen]"),
          this.$element
            .off("." + a)
            .removeData(a)
            .attr("style", ""),
          this.$overlay.remove(),
          this.$navigate.remove(),
          this.$element.trigger(r.DESTROYED),
          (this.$element = null);
      },
      getState: function () {
        return this.state;
      ...
      setHeader: function (t) {
        t
          ? this.$element.find("." + a + "-header").show()
          : ((this.headerHeight = 0),
            this.$element.find("." + a + "-header").hide());
      },
      setTitle: function (t) {
        (this.options.title = t),
          0 === this.headerHeight && this.createHeader(),
          0 === this.$header.find("." + a + "-header-title").length &&
            this.$header.append('<h2 class="' + a + '-header-title"></h2>'),
          this.$header.find("." + a + "-header-title").html(t);
      },
      setSubtitle: function (t) {
        "" === t
          ? (this.$header.find("." + a + "-header-subtitle").remove(),
            this.$header.addClass(a + "-noSubtitle"))
          : (0 === this.$header.find("." + a + "-header-subtitle").length &&
              this.$header.append('<p class="' + a + '-header-subtitle"></p>'),
            this.$header.removeClass(a + "-noSubtitle")),
          this.$header.find("." + a + "-header-subtitle").html(t),
          (this.options.subtitle = t);
      },
      setIcon: function (t) {
        0 === this.$header.find("." + a + "-header-icon").length &&
          this.$header.prepend('<i class="' + a + '-header-icon"></i>'),
          this.$header
            .find("." + a + "-header-icon")
            .attr("class", a + "-header-icon " + t),
          (this.options.icon = t);
      },
      setIconText: function (t) {
        this.$header.find("." + a + "-header-icon").html(t),
      ...
      startLoading: function () {
        this.$element.find("." + a + "-loader").length ||
          this.$element.append('<div class="' + a + '-loader fadeIn"></div>'),
          this.$element.find("." + a + "-loader").css({
      ...
      stopLoading: function () {
        ...
        t.length ||
          (this.$element.prepend('<div class="' + a + '-loader fadeIn"></div>'),
          (t = this.$element
            .find("." + a + "-loader")
      ...
      recalcLayout: function () {
        var e = this,
          ...
          m = 0;
        i() &&
          (h >= o.width() || this.isFullscreen === !0
            ? this.$element.css({ left: "", marginLeft: "" })
            : this.$element.css({ left: "50%", marginLeft: -(h / 2) })),
          this.options.borderBottom === !0 && (m = 3),
          this.$element.find("." + a + "-header").length &&
          this.$element.find("." + a + "-header").is(":visible")
            ? ((this.headerHeight = parseInt(
                this.$element.find("." + a + "-header").innerHeight(),
              )),
          ...
          (this.state != r.OPENED && this.state != r.OPENING) ||
            (this.options.iframe === !0 &&
              (s < this.options.iframeHeight + this.headerHeight + m ||
              this.isFullscreen === !0
                ? this.$element
                    .find("." + a + "-iframe")
                    .css("height", s - (this.headerHeight + m))
                : this.$element
                    .find("." + a + "-iframe")
            ...
            this.isFullscreen === !1 && this.$element.width() >= o.width()
              ? this.$element.find("." + a + "-button-fullscreen").hide()
              : this.$element.find("." + a + "-button-fullscreen").show(),
            this.recalcButtons(),
            this.isFullscreen === !1 &&
              (s =
                s - (n(this.options.top) || 0) - (n(this.options.bottom) || 0)),
            c > s
              ? (this.options.top > 0 &&
                ...
                t("html").addClass(a + "-isAttached"),
                this.$element.css("height", s))
              : (this.$element.css("height", d + (this.headerHeight + m)),
                this.$element.removeClass("isAttachedTop isAttachedBottom"),
                t("html").removeClass(a + "-isAttached")),
            (function () {
              d > u && c > s
                ? (e.$element.addClass("hasScroll"),
                  e.$wrap.css("height", l - (e.headerHeight + m)))
      ...
      recalcButtons: function () {
        var t =
          this.$header.find("." + a + "-header-buttons").innerWidth() + 10;
        this.options.rtl === !0
    ...
    o
      .off("hashchange." + a + " load." + a)
      .on("hashchange." + a + " load." + a, function (e) {
        ...
        if (0 === d)
          if ("" !== i) {
            t.each(t("." + a), function (e, n) {
              ...
              ("opened" != o && "opening" != o) ||
                ("#" + t(n)[0].id !== i && t(n).iziModal("close"));
            });
            try {
              var n = t(i).data();
              "undefined" != typeof n &&
                ("load" === e.type
                  ? n.iziModal.options.autoOpen !== !1 && t(i).iziModal("open")
                  : setTimeout(function () {
                      t(i).iziModal("open");
                    }, 200));
            } catch (o) {}
          } else
            t.each(t("." + a), function (e, i) {
    ...
    s
      .off("click", "[data-" + a + "-open]")
      .on("click", "[data-" + a + "-open]", function (e) {
        e.preventDefault();
        var i = t("." + a + ":visible"),
        ...
        void 0 !== s
          ? i.iziModal("close", { transition: s })
          : i.iziModal("close"),
          setTimeout(function () {
            void 0 !== o
              ? t(n).iziModal("open", { transition: o })
              : t(n).iziModal("open");
          }, 200);
      }),
    s.off("keyup." + a).on("keyup." + a, function (e) {
      if (t("." + a + ":visible").length) {
        ...
        void 0 === i ||
          ...
          (37 === o.keyCode
            ? t("#" + i).iziModal("prev", o)
            : 39 === o.keyCode && t("#" + i).iziModal("next", o));
      }
    }),
    (t.fn[a] = function (e, i) {
      ...
      for (var r = this, l = 0; l < r.length; l++) {
        ...
        if (u || (e && "object" != typeof e)) {
          if ("string" == typeof e && "undefined" != typeof u)
            return u[e].apply(u, [].concat(i));
        } else h.data(a, (u = new c(h, p)));
        p.autoOpen &&
          (isNaN(parseInt(p.autoOpen))
            ? p.autoOpen === !0 && u.open()
            : setTimeout(function () {
                u.open();
              }, p.autoOpen),
